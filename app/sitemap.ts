...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = "https://packages.christhapa.com.np"
  ...
  return [
    ...
    { url: `${baseUrl}/packages/extensions-core`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/packages/kundali-chart`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${baseUrl}/docs/extensions-core`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.7 },
    { url: `${baseUrl}/docs/kundali-chart`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.7 },
  ]
}
